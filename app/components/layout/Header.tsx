  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[rgba(251,251,253,0.8)] backdrop-blur-xl backdrop-saturate-[180%] dark:bg-[rgba(29,29,31,0.8)]">
      <div className="max-w-[734px] mx-auto px-6 h-11 flex items-center justify-between">
        ...
        <Link
          href="/settings"
          className="w-9 h-9 flex items-center justify-center rounded-full hover:bg-[var(--border-light)] transition-colors"
          aria-label="설정"
        >
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-[22px] h-[22px] text-[var(--text-secondary)]"
          >
            <path
              strokeLinecap="round"
