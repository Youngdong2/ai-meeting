...
export default function BottomNavigation() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-t border-gray-200/50 dark:bg-black/80 dark:border-gray-800/50 pb-safe">
